...
const AboutSection = () => {
  ...
  const interests = [
    ...
    },
    {
      ...
      icon: <PiTelevisionSimpleBold className="text-blue-500" />,
    },
    {
    ...
    },
    {
      ...
      icon: <FaCat className="text-orange-500" />,
    },
  ];
  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-4 sm:p-6 rounded-xl shadow-sm transform transition-all duration-300 hover:shadow-md">
